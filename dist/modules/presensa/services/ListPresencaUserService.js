...
exports.ListPresencaUseraService = void 0;
...
let ListPresencaUseraService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  return (0, _tsyringe.inject)('Presenca')(target, undefined, 0);
}, _dec3 = function (target, key) {
  return (0, _tsyringe.inject)('Cache')(target, undefined, 1);
}, _dec4 = Reflect.metadata("design:type", Function), _dec5 = Reflect.metadata("design:paramtypes", [typeof _IPresençaRepository.IPresencaRespository === "undefined" ? Object : _IPresençaRepository.IPresencaRespository, typeof _ICacheProvider.default === "undefined" ? Object : _ICacheProvider.default]), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = class ListPresencaUseraService {
  ...
  async execute({
    ...
    let list = await this.cache.recover(`presenca:${user_id}`);

    if (!list) {
      list = await this.presencaRepository.listAllPresenseWithUserId(user_id);
...
exports.ListPresencaUseraService = ListPresencaUseraService;