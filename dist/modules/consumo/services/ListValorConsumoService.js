...
let ListValorConsumoService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  return (0, _tsyringe.inject)('PrismaConsumo')(target, undefined, 0);
}, _dec3 = function (target, key) {
  return (0, _tsyringe.inject)('PrismaUser')(target, undefined, 1);
}, _dec4 = Reflect.metadata("design:type", Function), _dec5 = Reflect.metadata("design:paramtypes", [typeof _IConsumoRepository.IConsumoRepository === "undefined" ? Object : _IConsumoRepository.IConsumoRepository, typeof _IUsersRespository.IUsersRepository === "undefined" ? Object : _IUsersRespository.IUsersRepository]), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = class ListValorConsumoService {
  ...
  async execute() {
    ...
    const data = finAllUser.map(user => {
      const filtroConsumo = findConsumo.filter(h => h.consumidor_id === user.id);
      ...
      return {
        ...
        total: valor,
        data: filtroData === null || filtroData === void 0 ? void 0 : filtroData.created_at
      };
    });
...
exports.ListValorConsumoService = ListValorConsumoService;